...
<body>      
  ...
  <div class="grid">
        ...
        <div class="paginicial "><h3>Página Inicial</h3></div>    
          <div class="containerPostar">
            ...
            <div class="containerImgInput">
              ...
              <input class="tweetar" name="tweet" placeholder="O que está acontecendo?" type="text">
            </div>           
                <div class="enviar">
                  <div class="icon">
                    <table>
                    ...
                    echo "<div class=colunaTwitter><table >
                            <tr >
                                <th class=fotoUsuario>
                                  <img class=fotoUsuario src=img/foto_usuario.jpg>
                                </th>
    ...
    <div class="gridAnuncios">
      <div class="conteinerBusca">busca
          <div class="buscar">    
