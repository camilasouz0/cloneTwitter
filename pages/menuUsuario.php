  ...
  <body>      
    ...
    <div class="grid">
      <div class="sidenav">
        ...
        <main class="content">
          <div class="paginicial"><h3>Página Inicial</h3></div>    
          <div class="containerPostar">
            <form class="postar_tweet" method="POST" action="pages/tweets.php">
              <div class="containerImgInput">
                <img class="fotoUsuario" width="50" height="50"src="img/foto_usuario.jpg">
                <div class="enviarEicon"> 
                <input autocomplete="off" class="tweetar" name="tweet" placeholder="O que está acontecendo?" type="text">
                  ...
                  <div class="icons">
                    ...
                    <input class="botaoEnviar" name="meu_tweet" type="submit" value="Tweetar">   
                  </div>
                </div>         
              </form>
            </div>
            ...
            <?php
                ...
                $pegarTweets = $con -> prepare("SELECT post.tweet, post.id, post.idTweet, usuario.nome, COUNT(likePost.idPost) FROM post,usuario,likePost WHERE post.id = usuario.id AND post.idTweet = likePost.idPost GROUP BY post.idTweet, likePost.idPost");
                $pegarTweets->execute();     
                $Tweets = $pegarTweets->fetchAll(PDO::FETCH_ASSOC);
                
                foreach($Tweets as $mTweets) {     
                    echo 
                    "<div class=colunaTwitter>
                      <table>
                        <tr>
                          <th><img class=fotoUsuario src=img/foto_usuario.jpg></th>
                          <td><h4>",$mTweets['nome'],"<label> @",$mTweets['nome']," -</label></h4></td>
                        </tr>
                        <tr>
                          <th></th>
                          <td class=mostrarTweet>",$mTweets['tweet'],"</td>
                        </tr>               
                      </table>  
                    </div>
                  
                    <div class=containerLike>
                      <a class=subLike name=like href=like?idPost=",$idPost = $mTweets['idTweet'],">like(",$mTweets['COUNT(likePost.idPost)'],")</a></div>";
                  }
              ?>            
      </main> 
      
      <div class="gridAnuncios">
        <div class="conteinerBusca">
          <div class="buscar">    
